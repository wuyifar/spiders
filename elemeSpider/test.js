    ...
    var a = new function() {
        ...
        this.encode = function(e, a) {
            if (e instanceof Array && null == a && (a = e[1],
            e = e[0]),
            e *= 1,
            a *= 1,
            e !== e)
            ...
            for (var i, s, c = e.toString().length - e.toFixed().length - 2, l = a.toString().length - e.toFixed().length - 2, u = n(10, -t(c, l, 0)) / 2, d = new o, f = [], p = 180, h = !0, m = 0, g = 4; p >= u; )
                if (h ? (i = d.halfLng(),
                a > i ? (m |= 1 << g,
                d.minlng = i) : d.maxlng = i) : (i = d.halfLat(),
                e > i ? (m |= 1 << g,
                d.minlat = i) : d.maxlat = i),
                h = !h,
                g)
                    g--;
                else {
                    if (s = p,
                    p = t(d.maxlng - d.minlng, d.maxlat - d.minlat),
                    s === p)
                        break;
                    f.push(r[m]),
                    g = 4,
        ...
        this.decode = function(s) {
            if (!i.test(s))
                throw new Error("Geohash.decode: hash must be a geohash string");
            for (var c = new o, l = 90, u = 180, d = function(e, t, n) {
                ...
                for (var h = r.indexOf(s[f]), m = 1 & f, g = 4; g >= 0; g--)
                    d(g, h, m);
                m ? (l /= 8,
                u /= 4) : (l /= 4,
                u /= 8)
